...
[Developing a duobody for<br>treating Alzheimer's disease<br>in squirrel monkeys]{.custom-title}
...
[Massbiologics of UMMS]{.custom-url-mbl}
...
::: notes
`r if (format(Sys.time(), "%H") < 12) {   "Good morning" } else {   "Good afternoon" }` everyone. Thank you for the opportunity to present my work here. My name is Shubham Dutta, and I’m excited to share with you a unique and ongoing project where I have developed a duobody for treating Alzheimer’s disease in squirrel monkeys.
:::
